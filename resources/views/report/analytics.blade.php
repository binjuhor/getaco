...
@section('content')
    @if($forms->count())
        <div class="row reportRow reports_header">
...
{{--
        ...
        <div class="row content_table reportRow">
            <div class="col-md-12" id="reportUrl">
                <table class="table table-noaction" id="table_format">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-left"><a href="{{ $urlInfor->from_url }}" 
                                class="btn-link name" target="_blank">{{ $urlInfor->from_url }}</a>
                            </td>
